...
<div class="main_column column">
	...
	<form action="settings.php" method="POST">
		...
		<?php 
			if($message!=""){
				echo "<p class='wonder' style='display: block;'>". $message. "</p>";
			}
		?>

		<input type="submit" name="update_details" value="Update Details" class="info settings_submit">
	</form>
	...
	<form action="settings.php" method="POST">
		...
		<?php 
			if($password_message!=""){
				echo "<p class='wonder' style='display: block;'>". $password_message. "</p>";
			}
		?>

		<input type="submit" name="update_password" value="Update Password" class="info settings_submit"><br>
	</form>
